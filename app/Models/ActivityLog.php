...
class ActivityLog extends Model
{
    ...
    public function label(): string
    {
        return match ($this->action) {
            ...
            'deletion_requested' => 'Đề nghị xóa nhân viên/phòng ban',
            'deletion_approved' => 'Giám đốc duyệt xóa',
            'deletion_rejected' => 'Giám đốc từ chối xóa',
            ...
            'account_deleted_after_employee' => 'Admin xóa tài khoản sau khi xóa nhân viên',

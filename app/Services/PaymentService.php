...
class PaymentService
{
    public function createPaymentFromPayroll(Payroll $payroll, ?string $notes = null): SalaryPayment
    {
        ...
        $payment = SalaryPayment::create([
            ...
            'net'             => $net,
            'payment_method'  => ($employee->account_number ?: $employee->bank_account_number) ? 'bank_transfer' : 'cash',
            'bank'            => $employee->bank_name,
            'account_holder'  => $employee->account_holder ?: $employee->bank_account_holder,

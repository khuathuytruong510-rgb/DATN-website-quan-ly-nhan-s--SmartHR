...
<div class="container-fluid py-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Thông tin hợp đồng, khóa tài liệu và lịch sử ký số.</p>
        </div>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12"><small class="text-muted">{{ config('esign.disclaimer') }}</small></div>
                    </div>
                </div>
            </div>

...
<section class="grid emp-kpis">
    <article class="emp-kpi is-info">
        ...
        <div class="emp-kpi-value" style="font-size:1.25rem;">{{ number_format($payroll['totalFund'], 0, ',', '.') }} đ</div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:20px;">
    <section>
        <h2 class="section-title" style="margin-top:0;">Nghỉ phép (báo cáo)</h2>
        <div class="grid emp-kpis" style="grid-template-columns:1fr 1fr;">
            <article class="emp-kpi is-warn">
                <div class="emp-kpi-head">
        ...
        <p class="muted" style="margin:10px 0 0;font-size:12px;">Giám đốc xem báo cáo nghỉ phép. HR/quản lý xử lý từng đơn.</p>
    </section>

    <section>
        <h2 class="section-title" style="margin-top:0;">Chấm công tháng {{ $monthLabel }}</h2>
        <div class="grid emp-kpis" style="grid-template-columns:1fr 1fr;">
            <article class="emp-kpi is-ok">
                <div class="emp-kpi-head">
...
<div class="card">
    <div style="font-weight:700;margin-bottom:12px;">Hợp đồng sắp hết hạn</div>
    @if($expiringContracts->isEmpty())
        <p class="muted" style="margin:0;">Không có hợp đồng hết hạn trong 30 ngày tới.</p>
    @else
        <table>
            <thead>
                <tr>
...
<style>
    @media (max-width: 900px) {
        section > div[style*="grid-template-columns"] { grid-template-columns: 1fr 1fr !important; }

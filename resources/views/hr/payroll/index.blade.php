...
<form action="{{ route('payroll.send', $p) }}" method="POST" style="display:inline;">
    @csrf
...
<form action="{{ route('payroll.pay', $p) }}" method="POST" style="display:inline;">
    @csrf
    <button type="submit"
            class="btn"
...
@endif
        ...
        <form method="POST" 
              action="{{ route('payroll.destroy', $p) }}" 
